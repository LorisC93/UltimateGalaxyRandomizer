...
public static class Moves
{
    ...
    public const uint MissTotemSkill = 0x9A1F8583;
    public static readonly IReadOnlyDictionary<MoveType, List<uint>> TotemSkillsByPosition = new Dictionary<MoveType, List<uint>>
    {
        {
            MoveType.Dribble,
            [
